...
for i in range(len(contours)):
    cv2.drawContours(back_ground, contours, i, (255, 0, 0), 3, 8, hierarchy)
    cv2.drawContours(back_ground, hull, i, (0, 255, 0), 1, 8, hierarchy)

cv2.imshow('Back Ground', back_ground)
cv2.waitKey(0)
